...
public class PostOrderTraversal {
	...
	public static void main(String[] args) {
		...
		System.out.println("Tree with 2 leaf nodes: " + postorderTraversal(root1));
		System.out.println();
		
		// Test Case 2: Edge case - single node (is itself a leaf)
		System.out.println("Test 2: Single node");
		TreeNode root2 = new TreeNode(1);
		System.out.println("Single node tree: " + postorderTraversal(root2));
		System.out.println();
		
		// Test Case 3: Edge case - null tree
		System.out.println("Test 3: Null tree");
		TreeNode root3 = null;
		System.out.println("Null tree: " + postorderTraversal(root3));
	}
	static List<Integer> outputList;
	/**
	 * Performs postorderTraversal operation.
	 *
